    ...
    def screen_switches(self):
        ...
        if game.clan.game_mode != "classic":
            self.help_button = UIImageButton(
                ...
                " these to any hurt or sick scugs that need them, helping those scugs to heal quicker."
                "<br><br>"
                "Hover your mouse over the clerics image to see what herbs your Clan has!",
            )
        ...
        if self.meds:
            ...
            if herb_amount == 0:
                ...
                if len(self.meds) == 1:
                    med_concern = f"The Ascended has blessed them with plentiful herbs and the cleric sends their thanks to the Void."
                else:
                    med_concern = f"The Ascended has blessed them with plentiful herbs and the clerics send their thanks to the Void."
